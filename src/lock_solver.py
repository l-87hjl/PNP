...
def solve_lock(instance: LockInstance) -> Optional[LockSolution]:
    """
    ...
    if solver.solve():
        ...
        solver.delete()
        return LockSolution(dial_values=dial_values)
    else:
        solver.delete()
        return None
...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python lock_solver.py <instance_file.json>")
        print()
        print("Solves a lock instance and outputs the solution.")
        sys.exit(1)
